...
from _helpers import (get_bq, build_campaign_filter,
    ...
    def do_GET(self):
        try:
            ...
            if not auth.startswith("Bearer "):
                return self._send(error_response("Não autorizado.", 401))
            ...
            self._send(error_response("Sessão expirada. Faça login novamente.", 401))
